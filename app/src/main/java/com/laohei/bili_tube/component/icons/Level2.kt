...
internal val Icons.Outlined.Level2: ImageVector
    get() {
        if (level2 != null) {
            return level2!!
        }
        level2 = Builder(
            name = "Level2", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var level2: ImageVector? = null