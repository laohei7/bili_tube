...
internal val Icons.Outlined.Level1: ImageVector
    get() {
        if (level1 != null) {
            return level1!!
        }
        level1 = Builder(
            name = "Level1", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(
                ...
                moveTo(860.8f, 662.4f)
                curveToRelative(0f, 9.6f, -9.6f, 19.2f, -19.2f, 19.2f)
                horizontalLineTo(723.2f)
                curveToRelative(-9.6f, 0f, -19.2f, -9.6f, -19.2f, -19.2f)
                verticalLineToRelative(-25.6f)
                curveToRelative(0f, -9.6f, 9.6f, -19.2f, 19.2f, -19.2f)
                horizontalLineToRelative(25.6f)
...
private var level1: ImageVector? = null