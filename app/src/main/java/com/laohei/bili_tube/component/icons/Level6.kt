...
internal val Icons.Outlined.Level6: ImageVector
    get() {
        if (level6 != null) {
            return level6!!
        }
        level6 = Builder(
            name = "Level6", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(
                ...
                moveTo(732.8f, 617.6f)
                horizontalLineToRelative(108.8f)
                verticalLineTo(544.0f)
                horizontalLineToRelative(-108.8f)
...
private var level6: ImageVector? = null