...
internal val Icons.Outlined.Level4: ImageVector
    get() {
        if (level4 != null) {
            return level4!!
        }
        level4 = Builder(
            name = "Level4", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var level4: ImageVector? = null