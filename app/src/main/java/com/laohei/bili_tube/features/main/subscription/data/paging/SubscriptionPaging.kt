package com.laohei.bili_tube.features.main.subscription.data.paging
...
class SubscriptionPaging(
    ...
    private val filterTypes = listOf(
        DynamicItem.Companion.DYNAMIC_TYPE_AV,
        DynamicItem.Companion.DYNAMIC_TYPE_DRAW,
//        DynamicItem.Companion.DYNAMIC_TYPE_ARTICLE
    )
