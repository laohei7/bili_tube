...
private data class HistoryOption(
...
@Composable
private fun buildHistoryOptions(): List<HistoryOption> {
...
@Composable
internal fun HistoryOptionsSheet(
    ...
    val historyOptions = buildHistoryOptions()
    ...
    ModalBottomSheet(
        ...
        historyOptions.fastForEach { option ->
            ListItem(
...
@Composable
private fun HistoryOptionsSheetPreview() {
    HistoryOptionsSheet(
        isSheetVisible = true,
        onDismissRequest = {},
        onItemClick = {}
